...
<div class="card">
    <div class="card-body">
        <form action="{{ route('meetings.decisions.update', [$meeting, $decision]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
                ...
                <div>
                    ...
                    <select name="decision_type" class="form-select @error('decision_type') is-invalid @enderror">
                        ...
                        <option value="noted" {{ old('decision_type', $decision->decision_type) === 'noted' ? 'selected' : '' }}>Noted</option>
                        <option value="further_discussion_required" {{ old('decision_type', $decision->decision_type) === 'further_discussion_required' ? 'selected' : '' }}>Further Discussion Required</option>
                    </select>
